...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">{t.features.scalable.description}</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <div className="h-12 w-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">{t.features.secure.description}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 px-4 bg-blue-500 dark:bg-blue-600">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">IgnitionAI</span>
            </div>
      ...
      {selectedService && (
        <ServiceModal
          ...
          service={{
            ...
            description: t.services[selectedService as keyof typeof t.services].description,
            details: t.services[selectedService as keyof typeof t.services].details,
            benefits: t.services[selectedService as keyof typeof t.services].benefits,
          }}
        />
      )}
